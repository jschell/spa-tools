...
|------|-------------|--------|
| [EPUB Preparer](epub-preparer.html) | Edit EPUB metadata, strip Project Gutenberg boilerplate, and download the corrected file. | 2026-02-28 |
| [F1 Race Tracker](f1-race-tracker.html) | Formula 1 race timing tower with live gaps, intervals, tyre data, and race control feed powered by OpenF1. | 2026-02-28 |
